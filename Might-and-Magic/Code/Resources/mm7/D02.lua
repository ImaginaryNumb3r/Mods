...
evt.map[176] = function()
	if not evt.Cmp("Awards", 93) then         -- "Returned Haldar's Remains"
		if not evt.Cmp("QBits", 161) then         -- Got magic dust out of chest 
			evt.OpenChest(1)
			evt.Add("QBits", 161)         -- Got magic dust out of chest 
			return
		end
	end
	evt.OpenChest(0)
