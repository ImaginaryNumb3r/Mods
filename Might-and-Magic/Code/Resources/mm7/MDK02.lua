...
evt.map[501] = function()
	if evt.Cmp("MapVar1", 2) then
		...
		evt.MoveToMap{X = 1114, Y = 1881, Z = 129, Direction = 1796, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDR02.blv"}
	end
end
...
evt.map[502] = function()
	if evt.Cmp("MapVar0", 2) then
		evt.MoveToMap{X = 915, Y = 2418, Z = 65, Direction = 1408, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDR05.blv"}
	else
		evt.MoveToMap{X = 28, Y = -1374, Z = 1, Direction = 512, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "D13.blv"}
	end
end
