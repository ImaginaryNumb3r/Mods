...
evt.map[1] = function()  -- function events.LoadMap()
	if not evt.Cmp("QBits", 208) then         -- Tularean Forest - Town Portal
		evt.Add("QBits", 208)         -- Tularean Forest - Town Portal
	end
...
evt.house[60] = 316  -- "Treasurestone Home"
evt.map[60] = function()
	evt.EnterHouse(316)         -- "Treasurestone Home"
end
...
evt.map[502] = function()
	evt.MoveToMap{X = 2071, Y = 448, Z = 1, Direction = 1024, LookAngle = 0, SpeedZ = 0, HouseId = 197, Icon = 3, Name = "D08.blv"}         -- "Tularean Caves"
end
...
evt.map[503] = function()
	...
	evt.SpeakNPC(88)         -- "Archibald Ironfist"
end
