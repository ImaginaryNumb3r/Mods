...
local function ProcessClassExtra()
	...
	local function CanLearnSkill(Skill, Class, Mastery, Player)
		Player = Player or Party[math.max(Game.CurrentPlayer, 0)]
		local t = {Skill = Skill, Class = Class, Player = Player, MaxLevel = Game.Classes.Skills[Class][Skill]}
