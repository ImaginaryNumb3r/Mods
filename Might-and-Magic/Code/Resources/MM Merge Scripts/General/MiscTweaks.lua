	...
	function events.CalcStatBonusByItems(t)
		...
		local Race = Game.CharacterPortraits[t.Player.Face].Race
	...
	local function PartyCanLearn(skill)
		for _,pl in Party do
			if pl.Skills[skill] == 0 and Game.Classes.Skills[pl.Class][skill] > 0 then
				return true
			end
		end
		return false
	...
	local function PlayerCanLearn(skill)
		...
		return pl.Skills[skill] == 0 and Game.Classes.Skills[pl.Class][skill] > 0
	end
