...
evt.map[505] = function()
	evt.MoveToMap{X = 9350, Y = -1010, Z = 1, Direction = 744, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 3, Name = "D35.blv"}
end

evt.hint[506] = evt.str[2]  -- "Leave Thunderfist Mountain"
evt.map[506] = function()
	evt.MoveToMap{X = -437, Y = -1078, Z = 1, Direction = 256, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 3, Name = "D36.blv"}
end
