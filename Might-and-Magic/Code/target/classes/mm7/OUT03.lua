...
evt.house[85] = 302  -- "Hillier Residence"
evt.map[85] = function()
	evt.EnterHouse(302)         -- "Hillier Residence"
end

evt.house[86] = 303  -- "Quixote Residence"
evt.map[86] = function()
	evt.EnterHouse(303)         -- "Quixote Residence"
end
...
evt.house[89] = 306  -- "Barnes Home"
evt.map[89] = function()
	evt.EnterHouse(306)         -- "Barnes Home"
end
