...
evt.map[501] = function()
	if evt.Cmp("MapVar1", 2) then
		evt.MoveToMap{X = -420, Y = 350, Z = 65, Direction = 384, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDT03.blv"}
	else
...
evt.map[502] = function()
	if evt.Cmp("MapVar0", 2) then
		...
		evt.MoveToMap{X = 477, Y = 286, Z = 1, Direction = 1280, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDT04.blv"}
	end
end
