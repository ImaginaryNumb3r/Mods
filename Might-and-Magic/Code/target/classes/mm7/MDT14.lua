...
evt.map[176] = function()
	if not evt.Cmp("MapVar0", 1) then
		if not evt.Cmp("QBits", 157) then         -- "Retrieve Davrik's Signet ring from the Bandit Caves in the northeast of Erathia and return it to Davrik Peladium in Harmondale."
			goto _2
		end
