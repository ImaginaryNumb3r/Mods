...
evt.map[501] = function()
	if evt.Cmp("MapVar1", 2) then
		evt.MoveToMap{X = 1951, Y = 1886, Z = 129, Direction = 1280, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDR02.blv"}
	else
		evt.MoveToMap{X = 412, Y = 298, Z = -15, Direction = 1792, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDT01.blv"}
	end
end
...
evt.map[502] = function()
	if evt.Cmp("MapVar0", 2) then
		evt.MoveToMap{X = -420, Y = 350, Z = 64, Direction = 384, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDT03.blv"}
	else
