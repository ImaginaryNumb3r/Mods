...
evt.map[501] = function()
	evt.MoveToMap{X = -7747, Y = 15880, Z = 6977, Direction = 0, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 4, Name = "Out12.odm"}
end

evt.hint[502] = evt.str[2]  -- "Leave the Cave"
evt.map[502] = function()
	evt.MoveToMap{X = -13812, Y = 16974, Z = 6656, Direction = 1536, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 4, Name = "out12.odm"}
end
