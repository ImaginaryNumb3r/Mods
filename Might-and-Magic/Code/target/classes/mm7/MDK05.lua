...
evt.map[501] = function()
	if evt.Cmp("MapVar1", 2) then
		evt.MoveToMap{X = -493, Y = -1049, Z = 1, Direction = 256, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDK02.blv"}
	else
		evt.MoveToMap{X = 925, Y = -684, Z = 65, Direction = 776, LookAngle = 0, SpeedZ = 0, HouseId = 0, Icon = 0, Name = "MDR01.blv"}
	end
end
