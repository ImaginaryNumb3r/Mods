...
local function MakeDragonChar()
	...
	if cHave then
		...
		GenerateMercenary{RosterId = cRosterId, Class = 10, Level = 1, Items = {}, Face = 25, Skills = {[const.Skills.DragonAbility] = 1, [const.Skills.Learning] = 1}}
	...
	Ungive = function()
		...
		if QSet.FoodEaten >= 100 then
			if Game.Time - QSet.FirstFeed > const.Month then
				...
				Game.NPC[DragonNPC].Pic = Game.CharacterPortraits[25].NPCPic
